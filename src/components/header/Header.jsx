        ...
        {type !== "list" && (
          <>
            <h1 className="headerTitle">
              Tận hưởng ưu đãi suốt đời với TravelNest!
            </h1>
            <p className="headerDesc">
              Nhận phần thưởng cho các chuyến đi của bạn - Mở  khóa tiết kiệm ngay lập tức 10% hoặc hơn với một tài khoản TravelNest miễn phí.
            </p>
